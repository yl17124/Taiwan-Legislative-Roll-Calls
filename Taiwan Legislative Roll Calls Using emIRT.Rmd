...
second_1 <- read_excel("2nd/二屆立委記名投票記錄正式版.xlsx") 
second_2 <- read_excel("2nd/第二屆立法院院會記名表決內容背景資料.xlsx")
second_3 <- read_excel("2nd/各黨各會期參與委員會.xlsx")
second_4 <- read_excel("2nd/第二屆黨籍立委(研究對象).xlsx")

# The 3rd Session Legislative Yuan
third_1 <- read_excel("3rd/記名投票紀錄更正版.xlsx")
third_2 <- read_excel("3rd/第三屆立法院院會記名表決內容背景資料.xlsx")
third_3 <- read_excel("3rd/政黨記名投票紀錄更正版 查詢.xlsx")
third_4 <- read_excel("3rd/常設委員會名單.xlsx")

# The 4th Session Legislative Yuan
fourth_1 <- read_excel("4th/四屆立委記名投票記錄.xlsx")
fourth_2 <- read_excel("4th/第四屆立法院院會記名表決內容背景資料.xlsx")
fourth_3 <- read_excel("4th/記名投票政黨 查詢.xlsx")
fourth_4 <- read_excel("4th/常設委員會名單.xlsx")

# The 5th Session Legislative Yuan
fifth_1 <- read_excel("5th/第五屆立委記名投票記錄.xlsx")
fifth_2 <- read_excel("5th/第五屆立法院院會記名表決內容背景資料.xlsx")
colnames(fifth_2)[colnames(fifth_2) == "編號"] <- "表決編號" 
fifth_3 <- read_excel("5th/綜合查詢.xlsx")
colnames(fifth_3)[colnames(fifth_3) == "第一會期黨團"] <- "黨籍"
fifth_4 <- read_excel("5th/常設委員會名單.xlsx")

# The 6th Session Legislative Yuan
sixth_1 <- read_excel("6th/第六屆立委記名投票紀錄.xlsx")
sixth_2 <- read_excel("6th/第六屆立法院院會記名表決內容背景資料 (另行編碼）.xlsx")
colnames(sixth_2)[colnames(sixth_2) == "編號"] <- "表決編號"
sixth_3 <- read_excel("6th/第六屆立委個人檔案 查詢.xlsx")
...
sixth_4 <- read_excel("6th/常設委員會名單FINAL.xlsx")

# The 7th Session Legislative Yuan
seventh_1 <- read_excel("7th/第七屆立委個人投票記錄2.xlsx")
seventh_2 <- read_excel("7th/第七屆立法院院會記名表決內容.xlsx")
colnames(seventh_2)[colnames(seventh_2) == "編號"] <- "表決編號"
seventh_3 <- read_excel("7th/第七屆立委個人檔案2.xlsx")
...
seventh_4 <- read_excel("7th/第七屆委員會名單.xlsx")

# The 8th Session Legislative Yuan
eighth_1 <- read_excel("8th/第八屆立委個人投票記錄.xlsx")
eighth_2 <- read_excel("8th/第八屆立法院院會記名表決內容.xlsx")
colnames(eighth_2)[colnames(eighth_2) == "編號"] <- "表決編號"
eighth_3 <- read_excel("8th/第八屆立委個人檔案2.xlsx")
...
eighth_4 <- read_excel("8th/第八屆委員會名單.xlsx")
```
